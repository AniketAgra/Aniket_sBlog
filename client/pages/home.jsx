    ...
    return (
        <div className={styles.homeRoot}>
            ...
            {latestByDate && (
                ...
                <section
                aria-labelledby="author-spotlight"
                style={{
                    marginTop: '3rem',
                    background: '#1f1630',
                    borderRadius: '14px',
                ...
                >
                    ...
                    <img
                        src="https://github.com/aniketagra.png"
                        alt="Aniket Agrawal GitHub Avatar"
                    ...
                    <h3
                        id="author-spotlight"
                        style={{ margin: 0, color: '#e2e8f0', fontSize: '1.125rem' }}
                    >
                        Aniket Agrawal
                    </h3>
                    <p style={{ margin: '6px 0 0 0', color: '#9aa3b2', lineHeight: 1.5 }}>
                        Developer, designer, and learner — building meaningful digital experiences while constantly exploring new technologies.
                    </p>
                    ...
                    <div style={{ display: 'flex', gap: 12, marginTop: 10 }}>
                        ...
                        <svg
                            ...
                            aria-hidden="true"
                        >
                            <path d="M18.244 2H21.5l-7.54 8.61L23 22h-7.21l-5.64-6.49L3.6 22H.34l8.05-9.2L1 2h7.28l5.08 5.77L18.24 2Zm-1.26 18h2.01L7.11 4H5.01L16.98 20Z" />
                        </svg>
                        </a>
                        ...
                        <svg
                            ...
                            aria-hidden="true"
                        >
                            <path d="M12 .5A11.5 11.5 0 0 0 .5 12.3c0 5.23 3.4 9.67 8.13 11.24.6.12.82-.26.82-.58v-2.1c-3.3.73-4-1.58-4-1.58-.55-1.43-1.33-1.8-1.33-1.8-1.08-.75.08-.73.08-.73 1.2.08 1.83 1.26 1.83 1.26 1.07 1.86 2.82 1.32 3.5 1 .1-.8.42-1.32.76-1.62-2.64-.31-5.43-1.36-5.43-6.06 0-1.34.46-2.44 1.24-3.3-.13-.3-.54-1.55.12-3.22 0 0 1-.33 3.3 1.25a11.3 11.3 0 0 1 6 0c2.29-1.58 3.29-1.25 3.29-1.25.66 1.67.25 2.92.12 3.22.78.86 1.24 1.96 1.24 3.3 0 4.72-2.8 5.74-5.46 6.04.43.38.81 1.1.81 2.22v3.29c0 .33.22.71.82.59A11.5 11.5 0 0 0 23.5 12.3 11.5 11.5 0 0 0 12 .5Z" />
                        </svg>
                        </a>
                        ...
                        <svg
                            ...
                            aria-hidden="true"
                        >
                            <path d="M4.98 3.5a2.5 2.5 0 1 0 0 5.001 2.5 2.5 0 0 0 0-5Zm.02 5.75H2V22h3V9.25Zm6 0H8.98V22H12V15c0-1.86.35-3.67 2.66-3.67 2.27 0 2.3 2.12 2.3 3.78V22H20v-7.52c0-3.67-1.97-5.38-4.6-5.38-2.11 0-3.04 1.15-3.4 1.95h-.04V9.25Z" />
                        </svg>
                        </a>
                    </div>
                    </div>
